...
// 	var rootToken *Token = &Token{Type: TokenTypeDocument, parent: nil}
// 	var lastToken *Token = rootToken
// 	runes := []rune(line)
// 	len := len(runes)
// 	pos := 0
// 	columnZero := true
...
// 	// close the last node
// 	if lastToken.Type != TokenTypeDocument {
// 		lastToken = lastToken.parent
// 	}

// 	// if there are still pending open tokens, we have an error
// 	if lastToken.Type != TokenTypeDocument {
