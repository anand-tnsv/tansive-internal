...
var (
	ErrCatalogError                           apperrors.Error = apperrors.New("catalog processing error").SetStatusCode(http.StatusInternalServerError)
	...
	ErrEmptyMetadata                          apperrors.Error = ErrCatalogError.New("metadata is empty").SetStatusCode(http.StatusBadRequest)
