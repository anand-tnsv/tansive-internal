...
var (
	...
	ErrInvalidViewDef     apperrors.Error = ErrSessionError.New("invalid view definition")
	ErrDisallowedByPolicy apperrors.Error = ErrSessionError.New("disallowed by policy")
)
