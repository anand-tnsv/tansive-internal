...
const (
	SkillService_InvokeSkill_FullMethodName = "/tansive.SkillService/InvokeSkill"
)
...
type SkillServiceClient interface {
	InvokeSkill(ctx context.Context, in *SkillInvocation, opts ...grpc.CallOption) (*SkillResult, error)
}
...
func (c *skillServiceClient) InvokeSkill(ctx context.Context, in *SkillInvocation, opts ...grpc.CallOption) (*SkillResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SkillResult)
	err := c.cc.Invoke(ctx, SkillService_InvokeSkill_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SkillServiceServer interface {
	InvokeSkill(context.Context, *SkillInvocation) (*SkillResult, error)
...
func (UnimplementedSkillServiceServer) InvokeSkill(context.Context, *SkillInvocation) (*SkillResult, error) {
...
func _SkillService_InvokeSkill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkillInvocation)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SkillServiceServer).InvokeSkill(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SkillService_InvokeSkill_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SkillServiceServer).InvokeSkill(ctx, req.(*SkillInvocation))
	}
...
var SkillService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tansive.SkillService",
	HandlerType: (*SkillServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "InvokeSkill",
			Handler:    _SkillService_InvokeSkill_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/tangent/session/proto/skill.proto",
}
